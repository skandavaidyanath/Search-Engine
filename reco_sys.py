...
def convert(data, min_user_index, max_user_index, doc_index, nb_documents):
	new_data = []
...
def main():
	...
	min_user_index = 1
	max_user_index  = 100
	training_set = convert(training_set,min_user_index, max_user_index, doc_index, nb_documents)
	test_set = convert(test_set,min_user_index, max_user_index, doc_index, nb_documents)
